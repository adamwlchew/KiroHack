 ...
 */
export type AppEvent = UserCreatedEvent | UserUpdatedEvent | UserPreferencesUpdatedEvent | ProgressUpdatedEvent | AchievementAwardedEvent | CompanionInteractionEvent | CompanionCustomizedEvent | ContentGeneratedEvent | ContentRatedEvent | DeviceSyncEvent;
